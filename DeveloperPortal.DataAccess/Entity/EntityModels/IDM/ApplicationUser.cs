using DeveloperPortal.DataAccess.Entity.Models.Helper;
...
namespace DeveloperPortal.DataAccess.Entity.EntityModels.IDM
{
    public class ApplicationUser
    {
        private readonly IDistributedCache _cache;

        public ApplicationUser(IDistributedCache cache)
        {
            _cache = cache;
        }
        ...
        public List<ApplicationUser> GetApplicationUsers() //static
        {
            List<ApplicationUser> users = null;

            var cachedValue = _cache.GetString("ApplicationUsers");

            if (cachedValue != null) {
                users = JsonConvert.DeserializeObject<List<ApplicationUser>>(cachedValue);
            }
        ...
        public ApplicationUser GetUser(string username) //static
        {
