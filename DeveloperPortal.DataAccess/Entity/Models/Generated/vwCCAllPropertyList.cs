...
public partial class vwCCAllPropertyList
{
    ...
    public int FullyAccessibleUnitCnt { get; set; }
    ...
    public string RentalSubsidy { get; set; } = null!;
    ...
    public int AccessibleUnits { get; set; }
}
