...
public partial class VwOlapConstructionDetail
{
    ...
    public DateTime? _5274DateOfMostRecentTco { get; set; }

    public DateTime? _5275DateOfMostRecentCofO { get; set; }

    public DateTime? _5276DateOfBuildingPermitFinaled { get; set; }
    ...
    public DateTime? _5284DateOfCurrentTco { get; set; }

    public DateTime? _5285DateOfCurrentCofO { get; set; }
    ...
    public DateTime? _831NonComplianceCaseOpenDate { get; set; }

    public string? _832NonComplianceCaseNumber { get; set; }

    public DateTime? _833OrderToComplyIssueDate { get; set; }

    public DateTime? _834ComplianceDueDate { get; set; }

    public bool? _835IsComplianceAchieved { get; set; }

    public DateTime? _835010OtccomplianceAchievedDate { get; set; }

    public DateTime? _836DueDateForAnyExtensionToComply { get; set; }

    public string? _837SubsequentActions { get; set; }

    public string? _838ResponsibleCityStaff { get; set; }

    public DateTime? _839DateNonComplianceCaseClosed { get; set; }

    public DateTime? _839010EnforcementComplianceAchievedDate { get; set; }

    public string? _839500CommentsConcerningEnforcement { get; set; }

    public DateTime? _839600DatePolicyComplianceDecertified { get; set; }

    public DateTime? _839700DatePolicyCertificateReIssued { get; set; }
    ...
    public DateTime? NewOwnershipDate { get; set; }
