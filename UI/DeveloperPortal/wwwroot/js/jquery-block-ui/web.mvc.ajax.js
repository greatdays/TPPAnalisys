...
function AjaxCommunication() {
    ...
    var message = '<span id="blockUIMessage"><i class="fas fa-spinner fa-spin"></i> Please wait...</span>'
    this.WaitMessage = message;
    this.WaitMessageZindex = 1555;
...
function fnBlockUI() {
    $.blockUI({
        message: '<span id="blockUIMessage"><i class="fas fa-spinner fa-spin"></i> Please wait...</span>',
        css: {
            top: "50%",
            left: "38%",
            width: "22%",
